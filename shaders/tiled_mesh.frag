...
void main() {
	...
	// if dirt and rock weights sum to more than 1.5, treat this as a special flag to skip drawing this mesh region (2.0 would be exactly at the skipped vertex)
	if (weights.g + weights.a > 1.5) {discard;}
