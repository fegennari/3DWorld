...
void main()
{
	...
	if (enable_light1) {color.rgb += add_light_comp_pos_scaled1(normal, epos, diffuse_scale*calc_light_scale(vertex.xyz, fg_LightSource[1].position), ambient_scale).rgb;}
