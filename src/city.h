...
struct pedestrian_t {
	...
	bool check_ped_ped_coll(vector<pedestrian_t> const &peds, unsigned pid) const;
	...
	void next_frame(cube_t const &plot_cube, vector<cube_t> const &colliders, vector<pedestrian_t> const &peds, unsigned pid, rand_gen_t &rgen);
};
