...
public:
	...
	void draw_cube(quad_batch_draw &qbd, cube_t const &c, color_wrapper const &cw, bool skip_bottom=0, float tscale=0.0,
		unsigned skip_dims=0, bool mirror_x=0, bool mirror_y=0, bool swap_tc_xy=0) const;
