...
struct ivy_wall_t {
	...
	void gen(cube_t const &wall, vect_cube_t const &avoid, float leaf_sz, unsigned face_mask, bool rand_select, bool is_house, rand_gen_t &rgen);
	void place_on_wall_face(cube_t const &wall, vect_cube_t const &avoid, bool dim, bool dir, bool is_house, float leaf_sz,
...
public:
	...
	void clear();
	void add_wall(cube_t const &wall, vect_cube_t const &avoid, bool dim, bool is_house, unsigned skip_dirs,
