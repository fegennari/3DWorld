...
building_interior_t::building_interior_t() : garage_room(-1), furnace_type(FTYPE_NONE), attic_type(ATTIC_TYPE_RAFTERS), door_state_updated(0), is_unconnected(0),
ignore_ramp_placement(0), placed_people(0), elevators_disabled(0), attic_access_open(0) {}
