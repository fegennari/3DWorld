...
struct person_base_t : public waiting_obj_t {
	...
	bool in_building=0, is_stopped=0, is_female=0, is_zombie=0, is_prisoner=0, is_on_stairs=0, path_is_fixed=0, lying_down=0; // Note: is_on_stairs includes escalators
...
enum {GOAL_TYPE_NONE=0, GOAL_TYPE_ROOM, GOAL_TYPE_ELEVATOR, GOAL_TYPE_ESCALATOR, GOAL_TYPE_PLAYER, GOAL_TYPE_PLAYER_LAST_POS, GOAL_TYPE_SOUND, GOAL_TYPE_RETREAT, NUM_GOAL_TYPES};
