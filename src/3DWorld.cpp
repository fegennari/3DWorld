...
bool player_custom_start_pos(0), enable_spec_map(1), enable_shine_map(1), enable_ssao(0), assert_on_gl_error(0), gl_errors_nonfatal(0), enable_reduce_leaves(1), tree_bindless_textures(0);
