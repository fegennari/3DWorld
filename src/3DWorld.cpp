...
bool store_cobj_accum_lighting_as_blocked(0), all_model3d_ref_update(0), begin_motion(0), enable_mouse_look(MOUSE_LOOK_DEF), enable_init_shields(1);
...
float custom_glaciate_exp(0.0), tree_type_rand_zone(0.0), jump_height(1.0);
