...
extern bool player_in_walkway, player_in_skyway, player_on_moving_ww, player_in_ww_elevator;
...
bool proc_city_sphere_coll(point &pos, point const &p_last, float radius, float prev_frame_zval, bool inc_cars, vector3d *cnorm, bool check_interior) {
	if (check_interior) {player_in_walkway = player_in_skyway = player_on_moving_ww = player_in_ww_elevator = 0;} // reset for next iteration if this is the player
