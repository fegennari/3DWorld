...
extern bool lm_alloc, has_snow, player_wait_respawn, camera_in_building, player_on_house_stairs, player_in_walkway, player_in_monorail;
...
void play_camera_footstep_sound() { // tiled terrain mode
	...
	last_pos = pos;
	fs_time  = tfticks;
	bool const not_in_building(!camera_in_building && !player_in_walkway && !player_in_monorail);
