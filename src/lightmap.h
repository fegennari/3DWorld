...
// from lightmap.cpp
void indir_light_tex_from_lmap(unsigned &tid, lmap_manager_t const &local_lmap_manager, unsigned xsize, unsigned ysize, unsigned zsize, float lighting_exponent=1.0);
