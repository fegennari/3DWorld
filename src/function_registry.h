...
void setup_smoke_shaders(shader_t &s, float min_alpha, int use_texgen, bool keep_alpha, bool indir_lighting, bool direct_lighting, bool dlights, bool smoke_en,
	...
	float triplanar_texture_scale=0.0, bool use_depth_trans=0, int enable_reflect=0, int is_outside=0, bool enable_rain_snow=1, bool is_cobj=0);
...
void gen_smoke(point const &pos, float zvel_scale=1.0, float radius_scale=1.0, colorRGBA const &color=WHITE, bool no_lighting=0);
...
int get_texture_by_name(std::string const &name, bool is_normal_map=0, bool invert_y=0, int wrap_mir=1);
...
void set_leaf_shader(shader_t &s, float min_alpha, unsigned tc_start_ix=0, bool enable_opacity=0, bool no_dlights=0, float wind_mag=0.0,
	bool underwater=0, bool use_fs_smap=0, bool enable_smap=1, bool enable_tex_coord_weight=0);
