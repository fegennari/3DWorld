...
void draw_health_bar(float health, float shields, float pu_time=0.0, colorRGBA const &pu_color=BLACK, float extra_bar=0.0, colorRGBA const &extra_bar_color=BLACK);
...
void draw_simple_cube(cube_t const &c, bool texture, unsigned dim_mask=0xFF);
...
int get_texture_by_name(std::string const &name, bool is_normal_map=0, bool invert_y=0, int wrap_mir=1, float aniso=0.0, bool allow_compress=1, bool use_mipmaps=1, unsigned ncolors=3);
