...
void set_light_colors(int light, float const ambient[4], float const diffuse[4]);
void set_colors_and_enable_light(int light, float const *const ambient, float const *const diffuse);
