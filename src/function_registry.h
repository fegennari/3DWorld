...
void draw_cylinder(float length, float radius1, float radius2, int ndiv, bool draw_ends=0, bool first_end_only=0, bool last_end_only=0);
...
void gen_decal(point const &pos, float radius, vector3d const &orient, int tid, int cid=-1, float init_alpha=1.0,
	colorRGBA const &color=BLACK, bool is_glass=0, bool rand_angle=0, int lifetime=60*TICKS_PER_SECOND);
