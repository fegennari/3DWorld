...
void add_sphere_quads(vector<vert_norm_tc> &verts, point const &pos, float radius, int ndiv, bool use_tri_strip=0, float s_beg=0.0, float s_end=1.0, float t_beg=0.0, float t_end=1.0);
