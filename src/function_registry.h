...
void setup_texgen_full(float sx, float sy, float sz, float sw, float tx, float ty, float tz, float tw, shader_t *shader=NULL);
void setup_texgen(float xscale, float yscale, float tx, float ty, float z_off=0.0);
