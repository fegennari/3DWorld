...
void set_gl_light_pos(int light, point const &pos, float w, bool call_gl_light=1);
void set_light_ds_color(int light, colorRGBA const &diffuse, bool call_gl_light=1);
void set_light_a_color(int light, colorRGBA const &ambient, bool call_gl_light=1);
void set_light_colors(int light, colorRGBA const &ambient, colorRGBA const &diffuse, bool call_gl_light=1);
void set_colors_and_enable_light(int light, colorRGBA const &ambient, colorRGBA const &diffuse, bool call_gl_light=1);
void clear_colors_and_disable_light(int light, bool call_gl_light=1);
void setup_gl_light_atten(int light, float c_a, float l_a, float q_a, bool call_gl_light=1);
int get_light();
...
void setup_smoke_shaders(shader_t &s, float min_alpha, int use_texgen, bool keep_alpha, bool indir_lighting, bool direct_lighting, bool dlights, bool smoke_en,
	bool has_lt_atten=0, bool use_smap=0, int use_bmap=0, bool use_spec_map=0, bool use_mvm=0, bool force_tsl=0, float burn_tex_scale=0.0);
