...
unsigned create_cube_map_reflection(unsigned &tid, point const &center, float near_plane, float far_plane, bool only_front_facing=0, bool is_indoors=0);
unsigned create_cube_map_reflection(unsigned &tid, cube_t const &cube, bool only_front_facing=0, bool is_indoors=0);
