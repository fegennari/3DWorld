...
public:
	...
	void get_quad_points(vector<vert_norm_tc> &quad_pts, bool use_tri_strip=0, float s_beg=0.0, float s_end=1.0, float t_beg=0.0, float t_end=1.0) const;
	void get_itri_points(vector<vert_norm_tc> &itri_pts, vector<unsigned> &indices, float s_beg=0.0, float s_end=1.0, float t_beg=0.0, float t_end=1.0) const;
