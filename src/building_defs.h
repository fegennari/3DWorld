...
bool const RESTROOM_HIGH_CEIL      = 1;
...
enum { // room object types
	...
	TYPE_SHELL_CASE, TYPE_PAN_SHELF, TYPE_JAR, TYPE_FOOD_TUB, TYPE_COM_FRIDGE, TYPE_BOILER, TYPE_ROCK_WALL, TYPE_TV_REMOTE,
	...
	TYPE_TOWEL_DISP, TYPE_SOAP_DISP, TYPE_HAND_DRYER, TYPE_EASEL, TYPE_GENERATOR, TYPE_WETF_SIGN,
...
enum {/*building models*/ OBJ_MODEL_TOILET=0, OBJ_MODEL_SINK, OBJ_MODEL_TUB, OBJ_MODEL_FRIDGE, OBJ_MODEL_STOVE, OBJ_MODEL_TV, OBJ_MODEL_MONITOR/*unused*/, OBJ_MODEL_COUCH,
	...
	OBJ_MODEL_TOWEL_DISP, OBJ_MODEL_SOAP_DISP, OBJ_MODEL_HAND_DRYER, OBJ_MODEL_EASEL, OBJ_MODEL_GENERATOR, OBJ_MODEL_WETF_SIGN,
...
enum {RTYPE_NOTSET=0, RTYPE_HALL, RTYPE_STAIRS, RTYPE_OFFICE, RTYPE_BATH, RTYPE_MENS, RTYPE_WOMENS, RTYPE_BED, RTYPE_KITCHEN, RTYPE_LIVING,
	...
	RTYPE_FAMILY, RTYPE_POWERGEN, RTYPE_OP_CENTER, RTYPE_CAVE,
	NUM_RTYPES};
...
"Family Room", "Power Generator", "Operations Center", "Cave"
};
...
enum {FLOORING_MARBLE=0, FLOORING_TILE, FLOORING_CONCRETE, FLOORING_CARPET, FLOORING_WOOD, FLOORING_LGTILE, FLOORING_RUBBER, FLOORING_ROCK, FLOORING_METAL, NUM_FLOORING_TYPES}; // not all are used
...
enum {ATTIC_TYPE_RAFTERS=0, ATTIC_TYPE_FIBERGLASS, ATTIC_TYPE_WOOD, ATTIC_TYPE_PLASTER, ATTIC_TYPE_OPEN, NUM_ATTIC_TYPES};
...
unsigned const RO_FLAG_UNTEXTURED= 0x1000; // for shirts, desks, and vent fans, aliased with RO_FLAG_ADJ_BOT
