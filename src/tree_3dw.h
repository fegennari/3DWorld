...
class tree : public tree_data_t {
	...
	point tree_center;
	float base_radius, sphere_center_zoff, sphere_radius, damage, damage_scale;
...
public:
	tree() : created(0), no_delete(0), reset_leaves(0),	leaves_changed(0), not_visible(0), sphere_center_zoff(0.0) {}
