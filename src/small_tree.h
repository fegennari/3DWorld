...
public:
	...
	void draw(int mode, bool shadow_only, bool do_cull, vbo_quad_block_manager_t const &vbo_manager, bool use_pine_leaf_gs=0, vector3d const xlate=zero_vector) const;
...
struct small_tree_group : public vector<small_tree> {
	...
	void draw_leaves(bool shadow_only, bool draw_all_pine=0, bool use_pine_leaf_gs=0, vector3d const xlate=zero_vector) const;
