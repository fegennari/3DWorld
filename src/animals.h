...
class butterfly_t : public animal_t {
	...
	bool dest_valid=0, is_mating=0, gender=0; // 0=male, 1=female
	float time=0, rest_time=0, mate_time=0, explore_time=0, speed_factor=1.0, rot_rate=0, alt_change=0, fwd_accel=0, rot_accel=0, alt_accel=0, dest_alignment=0;
