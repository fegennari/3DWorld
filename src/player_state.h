...
struct player_state { // size = big
	...
	int init_frame=0, fire_frame=0, was_hit=0, hitter=NO_SOURCE, last_teleporter=NO_SOURCE, target_visible=0, kill_time=0, rot_counter=0, uw_time=0, jump_time=0, freeze_time=0;
	int target_type=0, stopped_time=0, last_waypoint=-1;
	unsigned tid=0, fall_counter=0, chunk_index=0;
	float shields=0, plasma_size=0, zvel=0, dpos=0, last_dz=0, last_zvel=0, last_wpt_dist=0;
	double ticks_since_fired=0;
...
struct teleporter : public sphere_t, public volume_part_cloud {
	...
	bool is_portal=0, is_indoors=0, enabled=1;
