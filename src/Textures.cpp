...
extern unsigned smoke_tid, dl_tid, elem_tid, gb_tid, reflection_tid, room_mirror_ref_tid, depth_tid, empty_smap_tid, frame_buffer_RGB_tid, skybox_tid, skybox_cube_tid, univ_reflection_tid;
