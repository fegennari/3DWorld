...
enum {SOUND_BURNING=0, SOUND_RAIN1, SOUND_WIND1, SOUND_EXPLODE, SOUND_GUNSHOT, SOUND_SHOTGUN, SOUND_FIREBALL, SOUND_DROWN, SOUND_SCREAM1, SOUND_SCREAM2,
	...
	SOUND_SCARED, SOUND_GASP, SOUND_SCREAM3, SOUND_SQUEAL, SOUND_RICOCHET, SOUND_ROCK_FALL, SOUND_SPRAY, SOUND_CLICK, SOUND_SHELLC, SOUND_SH_DROP,
	SOUND_WATER_DROP, SOUND_SLIDING, SOUND_OBJ_FALL, NUM_SOUNDS};
