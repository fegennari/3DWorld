...
enum {SOUND_BURNING=0, SOUND_RAIN1, SOUND_WIND1, SOUND_UNDERWATER, SOUND_EXPLODE, SOUND_GUNSHOT, SOUND_SHOTGUN, SOUND_FIREBALL, SOUND_DROWN, SOUND_SCREAM1,
	...
	SOUND_FLY_BUZZ, SOUND_EATING, SOUND_BUBBLE, SOUND_NEON_SIGN, SOUND_SM_SPLAT, SOUND_POLICE, SOUND_ALARM, SOUND_SCRATCH, SOUND_HANDGUN, SOUND_HAND_DRYER,
	SOUND_HIT_TONE, SOUND_WHITE_NOISE, NUM_SOUNDS};
