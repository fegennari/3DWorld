...
enum {SOUND_BURNING=0, SOUND_RAIN1, SOUND_WIND1, SOUND_UNDERWATER, SOUND_EXPLODE, SOUND_GUNSHOT, SOUND_SHOTGUN, SOUND_FIREBALL, SOUND_DROWN, SOUND_SCREAM1,
	...
	SOUND_SPLASH1, SOUND_SPLASH2, SOUND_WATER, SOUND_THUNDER, SOUND_THUNDER2, SOUND_BOING, SOUND_SWING, SOUND_HISS, SOUND_DOH, SOUND_HURT, SOUND_DEATH,
	SOUND_AGONY, SOUND_SCARED, SOUND_GASP, SOUND_SCREAM3, SOUND_SQUEAL, SOUND_RICOCHET, SOUND_ROCK_FALL, SOUND_SPRAY, SOUND_CLICK, SOUND_SHELLC,
	SOUND_SH_DROP, SOUND_WATER_DROP, SOUND_SLIDING, SOUND_OBJ_FALL, SOUND_WOOD_CRACK, SOUND_FOOTSTEP, SOUND_SNOW_STEP, SOUND_ICE_CRACK, NUM_SOUNDS};
