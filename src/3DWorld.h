...
enum {RAIN = 0, SNOW, HAIL, LEAF, BALL, S_BALL, SMILEY, BLOOD, CHARRED, CHUNK,
	...
	WAYPOINT, SMOKE, DYNAM_PART, SKULL, GRASS, TELEPORTER, SAWBLADE, MAT_SPHERE, COLLISION, RAPT_PROJ,
	FREEZE_BOMB, NUM_TOT_OBJS};
...
enum {GROUND_TEX = 0, DARK_ROCK_TEX, WATER_TEX, STUCCO_TEX, CLOUD_TEX, BRICK2_TEX, MOON_TEX, EARTH_TEX, MARBLE_TEX, SNOW_TEX,
	...
	LAVA_TEX, SMOKE_PUFF_TEX, BARK5_TEX, BARK6_TEX, RIPPLE_MAP_TEX, STARBURST_TEX, ROCK1_NORMAL_TEX, ROCK2_NORMAL_TEX, ROCK3_NORMAL_TEX,
	NUM_PREDEF_TEXTURES
};
