...
public:
	...
	unsigned get_gpu_mem() const {return (is_bound() ? (num_bytes() + (use_mipmaps ? num_bytes()/3 : 0)) : 0);} // Note: ignores texture compression
...
enum {GROUND_TEX = 0, DARK_ROCK_TEX, WATER_TEX, STUCCO_TEX, CLOUD_TEX, BRICK2_TEX, MOON_TEX, EARTH_TEX, MARBLE_TEX, SNOW_TEX,
	...
	HAZARD_TEX, BLDG_WINDOW_TEX, KEYCARD_TEX, NUM_PREDEF_TEXTURES
};
