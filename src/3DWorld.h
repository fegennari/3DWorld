...
public:
	...
	bool wrap, invert_y, do_compress, has_binary_alpha, is_16_bit_gray, no_avg_color_alpha_fill, invert_alpha;
...
public:
	...
	texture_t(char t, char f, int w, int h, bool wra, int nc, int um, std::string const &n, bool inv=0, bool do_comp=1, float a=1.0, float maw=1.0)
		...
		no_avg_color_alpha_fill(0), invert_alpha(0), width(w), height(h), ncolors(nc), bump_tid(-1), alpha_tid(-1), anisotropy(a), mipmap_alpha_weight(maw),
