...
struct tex_range_t {
	...
	tex_range_t() : x1(0.0), y1(0.0), x2(1.0), y2(1.0), clip_quad(0) {}
	tex_range_t(float x1_, float y1_, float x2_, float y2_, bool clip_quad_=0) : x1(x1_), y1(y1_), x2(x2_), y2(y2_), clip_quad(clip_quad_) {}
...
enum {RAIN = 0, SNOW, HAIL, LEAF, BALL, S_BALL, SMILEY, BLOOD, CHARRED, CHUNK,
	...
	FREEZE_BOMB, XLOCATOR, XLOCATOR_DEATH, JUMP_PAD, NUM_TOT_OBJS};
...
enum {GROUND_TEX = 0, DARK_ROCK_TEX, WATER_TEX, STUCCO_TEX, CLOUD_TEX, BRICK2_TEX, MOON_TEX, EARTH_TEX, MARBLE_TEX, SNOW_TEX,
	...
	HAZARD_TEX, NUM_PREDEF_TEXTURES
};
