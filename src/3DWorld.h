...
public:
	...
	static void shader_setup(vpc_shader_t &s, unsigned noise_ncomp, bool ridged=1, float alpha_bias=-0.4, float dist_bias=0.0, unsigned num_octaves=5, bool enable_lighting=0);
...
enum {GROUND_TEX = 0, DARK_ROCK_TEX, WATER_TEX, STUCCO_TEX, CLOUD_TEX, BRICK2_TEX, MOON_TEX, EARTH_TEX, MARBLE_TEX, SNOW_TEX,
	...
	ROCK_NORMAL_TEX, RAINDROP_TEX, SPACESHIP1_TEX, SPACESHIP2_TEX, BLOOD_SPLAT_TEX, LICHEN_TEX, PALM_BARK_TEX, DAISY_TEX,
	LAVA_TEX, SMOKE_PUFF_TEX, BARK5_TEX, BARK6_TEX, RIPPLE_MAP_TEX, STARBURST_TEX, NUM_PREDEF_TEXTURES
};

// lighting files/types
enum {LIGHTING_SKY=0, LIGHTING_GLOBAL, LIGHTING_LOCAL, LIGHTING_DYNAMIC, LIGHTING_COBJ_ACCUM, NUM_LIGHTING_TYPES};

// heightmap generation modes
enum {MGEN_SINE=0, MGEN_SIMPLEX, MGEN_PERLIN, MGEN_SIMPLEX_GPU};
