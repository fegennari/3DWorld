...
bool camera_in_building(0), interior_shadow_maps(0), player_is_hiding(0), player_in_unlit_room(0), player_in_walkway(0), player_in_int_elevator(0);
bool building_has_open_ext_door(0), sec_camera_shadow_mode(0);
