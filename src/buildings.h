...
enum { // room object types
	...
	TYPE_GYM_WEIGHT, TYPE_FOOD_TRAY, TYPE_BAR_SOAP, TYPE_COAT_RACK, TYPE_O_SHOWER,
...
private:
	...
	bool fill_room_with_tables_and_chairs(rand_gen_t rgen, room_t const &room, float zval, unsigned room_id, float tot_light_amt, unsigned objs_start, bool plastic_tc);
