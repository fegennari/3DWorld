...
enum { // room object types
	...
	TYPE_MACHINE, TYPE_BUCKET, TYPE_SPIWEB, TYPE_TREE, TYPE_STORE_GATE, TYPE_THEFT_SENS, TYPE_ELEC_WIRE, TYPE_ERASER,
	...
	TYPE_BAR_STOOL, TYPE_PADLOCK, TYPE_CASHREG, TYPE_WFOUNTAIN, TYPE_BANANA, TYPE_BAN_PEEL, TYPE_CONF_PHONE, TYPE_GBIKE, TYPE_XFORMER, TYPE_US_FLAG,
	TYPE_BLDG_FOUNT,
	/* animals */
	TYPE_RAT, TYPE_ROACH, TYPE_SPIDER, TYPE_SNAKE, TYPE_INSECT, TYPE_FISH,
	NUM_ROBJ_TYPES};
...
enum {/*building models*/ OBJ_MODEL_TOILET=0, OBJ_MODEL_SINK, OBJ_MODEL_TUB, OBJ_MODEL_FRIDGE, OBJ_MODEL_STOVE, OBJ_MODEL_TV, OBJ_MODEL_MONITOR/*unused*/, OBJ_MODEL_COUCH,
	...
	OBJ_MODEL_BANANA, OBJ_MODEL_BAN_PEEL, OBJ_MODEL_PHONE, OBJ_MODEL_GBIKE/*unused*/, OBJ_MODEL_XFMR/*unused*/, OBJ_MODEL_US_FLAG/*unused*/, OBJ_MODEL_BLDG_FOUNT/*unused*/,
	...
	OBJ_MODEL_BICYCLE, OBJ_MODEL_SWINGSET, OBJ_MODEL_TRAMPOLINE, OBJ_MODEL_DUMPSTER, OBJ_MODEL_BIG_UMBRELLA, OBJ_MODEL_FLOWER, OBJ_MODEL_DECK_CHAIR, OBJ_MODEL_PICNIC, NUM_OBJ_MODELS};
...
public:
	...
	static void add_fishtank(cube_t const &tank, unsigned room_id, float tot_light_amt, bool dim, bool dir, bool in_pet_store,
		vect_room_object_t &objects, rand_gen_t &rgen, unsigned animal_type=TYPE_FISH);
private:
...
struct building_t : public building_geom_t {
	...
	bool is_single_large_room(room_t const &room) const {return(room.is_parking() || room.is_backrooms() || room.is_retail() || room.is_mall());}
...
private:
	...
	cube_t add_ext_basement_door(cube_t const &room, float door_width, bool dim, bool dir, bool is_end_room, bool is_tall_room, rand_gen_t &rgen);
	...
	bool add_chair(rand_gen_t &rgen, cube_t const &room, vect_cube_t const &blockers, unsigned room_id, point const &place_pos, colorRGBA const &chair_color,
		bool dim, bool dir, float tot_light_amt, bool office_chair=0, bool enable_rotation=0, bool bar_stool=0, bool no_push_out=0, int wooden_or_plastic=2);
	...
	void add_mall_store_objs(rand_gen_t rgen, room_t &room, float zval, unsigned room_id, light_ix_assign_t &light_ix_assign);
	...
	bool place_dcan_on_obj   (rand_gen_t &rgen, cube_t const &place_on, unsigned room_id, float tot_light_amt, vect_cube_t const &avoid=vect_cube_t());
