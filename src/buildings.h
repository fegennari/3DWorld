...
enum {BTYPE_UNSET=0, BTYPE_HOUSE, BTYPE_MULT_FAM, BTYPE_OFFICE, BTYPE_APARTMENT, BTYPE_HOTEL, BTYPE_HOSPITAL, BTYPE_PARKING, BTYPE_MALL, BTYPE_FACTORY,
	BTYPE_WAREHOUSE, BTYPE_POWERPLANT, BTYPE_SCHOOL, BTYPE_POLICE, BTYPE_FIRE_STAT, BTYPE_PRISON, NUM_BUILDING_TYPES};
...
enum { // room object types
	...
	TYPE_HOSP_BED, TYPE_HOSP_CURT, TYPE_FORKLIFT, TYPE_WHEELCHAIR, TYPE_OP_TABLE, TYPE_TROLLEY, TYPE_STRETCHER, TYPE_APPLE, TYPE_EX_MACHINE,
...
enum {FLOORING_MARBLE=0, FLOORING_TILE, FLOORING_CONCRETE, FLOORING_CARPET, FLOORING_WOOD, FLOORING_LGTILE, FLOORING_RUBBER, NUM_FLOORING_TYPES}; // Note: not all are used
...
enum {/*building models*/ OBJ_MODEL_TOILET=0, OBJ_MODEL_SINK, OBJ_MODEL_TUB, OBJ_MODEL_FRIDGE, OBJ_MODEL_STOVE, OBJ_MODEL_TV, OBJ_MODEL_MONITOR/*unused*/, OBJ_MODEL_COUCH,
	...
	OBJ_MODEL_WHEELCHAIR, OBJ_MODEL_OP_TABLE, OBJ_MODEL_TROLLEY, OBJ_MODEL_STRETCHER, OBJ_MODEL_APPLE, OBJ_MODEL_EX_MACHINE,
...
unsigned const RO_FLAG_USED     = 0x10000000; // used by the player (spraypaint, marker, etc.); used by parking spaces to indicate cars; used by school books and occupied beds
...
private:
	...
	void add_jail_cell_door(door_t const &D, door_rotation_t &drot);
...
private:
	...
	bool add_visit_room_objs (rand_gen_t rgen, room_t &room, float &zval, unsigned room_id, float tot_light_amt, unsigned objs_start, unsigned lights_start);
	...
	void replace_prison_cell_with_ext_door(float door_height, rand_gen_t &rgen);
