...
private:
	...
	void update_spider_pos_orient(spider_t &spider, point const &camera_bs, float timestep, bool &on_surface, bool &had_coll) const;
...
private:
	...
	void add_basement_pipes(vect_cube_t const &obstacles, vect_cube_t const &walls, vect_cube_t const &beams,
		unsigned room_id, unsigned num_floors, float tot_light_amt, float ceil_zval, rand_gen_t &rgen);
	void get_pipe_basement_connections(vector<sphere_t> &pcs) const;
