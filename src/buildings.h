...
enum {
	...
	TYPE_POOL_BALL, TYPE_POOL_CUE, TYPE_WALL_MOUNT, TYPE_POOL_TILE, TYPE_POOL_FLOAT, TYPE_BENCH, TYPE_DIV_BOARD,
...
private:
	...
	bool add_ball_to_room    (rand_gen_t &rgen, room_t const &room, cube_t const &place_area, float zval, unsigned room_id, float tot_light_amt, unsigned objs_start,
		int force_type=-1, cube_t const &avoid_xy=cube_t());
...
void get_road_seg_sphere_coll_cubes(point const &pos, float radius, bool xy_only, vect_cube_t &out);
