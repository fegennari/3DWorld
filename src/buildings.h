...
enum {BTYPE_UNSET=0, BTYPE_HOUSE, BTYPE_MULT_FAM, BTYPE_OFFICE, BTYPE_APARTMENT, BTYPE_HOTEL, BTYPE_HOSPITAL, BTYPE_PARKING, BTYPE_MALL, BTYPE_FACTORY,
	BTYPE_WAREHOUSE, BTYPE_POWERPLANT, BTYPE_SCHOOL, BTYPE_POLICE, BTYPE_FIRE_STAT, BTYPE_PRISON, BTYPE_RESTAURANT, NUM_BUILDING_TYPES};
...
enum { // room object types
	...
	TYPE_JUMPSUIT, TYPE_HANDGUN, TYPE_SHOP_CART, TYPE_CASHREG, TYPE_FOOD_FISH, TYPE_KITCH_APP, TYPE_MILK, TYPE_RADIATOR,
...
enum {/*building models*/ OBJ_MODEL_TOILET=0, OBJ_MODEL_SINK, OBJ_MODEL_TUB, OBJ_MODEL_FRIDGE, OBJ_MODEL_STOVE, OBJ_MODEL_TV, OBJ_MODEL_MONITOR/*unused*/, OBJ_MODEL_COUCH,
	...
	OBJ_MODEL_HANDGUN, OBJ_MODEL_SHOP_CART, OBJ_MODEL_CASHREG, OBJ_MODEL_FISH, OBJ_MODEL_CK_APP, OBJ_MODEL_MILK, OBJ_MODEL_RADIATOR,
