...
private:
	...
	void add_basement_pipes(vect_cube_t const &obstacles, vect_cube_t const &walls, unsigned room_id, unsigned num_floors, float tot_light_amt, float ceil_zval, rand_gen_t &rgen);
