...
struct building_params_t {
	...
	bool gen_building_interiors, add_city_interiors, enable_rotated_room_geom;
	...
	building_params_t(unsigned num=0) : flatten_mesh(0), has_normal_map(0), tex_mirror(0), tex_inv_y(0), tt_only(0), infinite_buildings(0), dome_roof(0),
		onion_roof(0), enable_people_ai(0), gen_building_interiors(1), add_city_interiors(0), enable_rotated_room_geom(0), num_place(num), num_tries(10), cur_prob(1),
		max_shadow_maps(32), ao_factor(0.0), sec_extra_spacing(0.0), player_coll_radius_scale(1.0), interior_view_dist_scale(1.0),
...
enum {
	...
	TYPE_DRAIN, TYPE_MONEY, TYPE_PHONE,
...
enum {OBJ_MODEL_TOILET=0, OBJ_MODEL_SINK, OBJ_MODEL_TUB, OBJ_MODEL_FRIDGE, OBJ_MODEL_STOVE, OBJ_MODEL_TV, OBJ_MODEL_MONITOR, OBJ_MODEL_COUCH, OBJ_MODEL_OFFICE_CHAIR, OBJ_MODEL_URINAL,
	OBJ_MODEL_LAMP, OBJ_MODEL_WASHER, OBJ_MODEL_DRYER, OBJ_MODEL_KEY, OBJ_MODEL_FHYDRANT, NUM_OBJ_MODELS};
