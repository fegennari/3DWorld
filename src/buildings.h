...
enum { // room object types
	...
	TYPE_MACHINE, TYPE_BUCKET, TYPE_SPIWEB, TYPE_TREE, TYPE_STORE_GATE, TYPE_THEFT_SENS, TYPE_ELEC_WIRE, TYPE_ERASER, TYPE_DWASHER,
...
private:
	...
	void add_mall_ceiling_ducts(room_t &room, float ceil_zval, unsigned room_id, bool dim, unsigned skip_dir, float light_amt, rand_gen_t &rgen);
