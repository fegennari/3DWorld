...
struct room_t : public cube_t {
	...
	room_t(cube_t const &c, unsigned p, bool is_hallway_=0) : cube_t(c), has_stairs(0), has_elevator(0), no_geom(is_hallway_),
		is_hallway(is_hallway_), is_office(0), ext_sides(0), part_id(p), lit_by_floor(0) {} // no geom in hallways
...
private:
	...
	void add_door_to_bdraw(cube_t const &D, building_draw_t &bdraw, bool dim, bool dir, bool opened, bool exterior) const;
	...
	void add_room(cube_t const &room, unsigned part_id, bool is_hallway=0);
