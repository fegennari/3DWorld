...
enum { // room object types
	...
	TYPE_MACHINE, TYPE_BUCKET, TYPE_SPIWEB,
...
private:
	...
	bool add_chair(rand_gen_t &rgen, cube_t const &room, vect_cube_t const &blockers, unsigned room_id, point const &place_pos,
		colorRGBA const &chair_color, bool dim, bool dir, float tot_light_amt, bool office_chair=0, bool enable_rotation=0, bool bar_stool=0, bool no_push_out=0);
	unsigned add_table_and_chairs(rand_gen_t rgen, cube_t const &room, vect_cube_t &blockers, unsigned room_id, point const &place_pos,
	...
	void add_food_court_objs(rand_gen_t &rgen, cube_t const &place_area, float zval, unsigned room_id, float tot_light_amt, vect_cube_t const &blockers);
