...
private:
	...
	void add_vent_to_room   (rand_gen_t rgen, room_t const &room, float zval, unsigned room_id, unsigned objs_start);
	bool check_of_placed_on_interior_wall(cube_t const &c, room_t const &room, bool dim, bool dir) const;
