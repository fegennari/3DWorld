...
enum { // room object types
	...
	TYPE_LAVALAMP, TYPE_SHOWERTUB, TYPE_TRASH, TYPE_VALVE,
...
struct building_walkway_t : public building_walkway_geom_t { // "owned" walkway, one per connected building
	...
	cube_t bcube_inc_rooms, monorail_conn;
...
void setup_building_draw_shader(shader_t &s, float min_alpha, bool enable_indir, bool force_tsl, int use_texgen, float water_damage=0.0);
