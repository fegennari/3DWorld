...
colorRGBA const TSHIRT_COLORS [NUM_TSHIRT_COLORS ] = {WHITE, BLACK, GRAY, RED, GREEN, BLUE, YELLOW, ORANGE, WHITE};
...
enum {
	...
	TYPE_FEXT_MOUNT, TYPE_FEXT_SIGN, TYPE_PIZZA_BOX, TYPE_TEESHIRT,
