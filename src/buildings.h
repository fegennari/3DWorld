...
private:
	...
	cube_t add_restaurant_counter(cube_t const &wall, bool dim, unsigned room_id, float light_amt, bool leave_end_gaps, bool with_cash_registers, rand_gen_t &rgen);
